...
export abstract class JettonWalletContractBase<T extends WalletOpcodesType> extends CommonContractBase {
    ...
    async sendTransfer(
        ...
        if (!this.opCodes.transfer) throw new Error('Not Implemented');
    ...
    async sendInternalTransfer(
        ...
        if (!this.opCodes.internalTransfer) throw new Error('Not Implemented');
    ...
    async sendBurn(
        ...
        if (!this.opCodes.burn) throw new Error('Not Implemented');
