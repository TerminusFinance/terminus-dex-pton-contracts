...
export function deployerConfigToCell(config: DeployerConfig): Cell {
    return beginCell().storeUint(1, 1).storeRef(config.publib).endCell();
}
...
// =======================================
export const DEFAULT_DEPLOYER_CODE = codeFromString(
    'b5ee9c72410103010027000114ff00f4a413f4bcf2c80b010128d3ed44d0d300018e88d43072fb0688ed549130e20200014013d4e9d2',
);
/*
